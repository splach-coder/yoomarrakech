...
function ActivityDetailPage({ params }) {
    ...
    const displayTitle = (isGroup ? t('activityGroupTitle', {
        type: item?.type ?? ''
    }) : `${item?.type} — ${item?.location}`).toUpperCase();
    const description = isGroup ? t('activityGroupDesc', {
        type: item?.type ?? ''
    }) : item?.desc || '';
...
_s(ActivityDetailPage, "h6+q2O3NJKPY5uL0BIJGLIanww8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$intl$2f$dist$2f$esm$2f$development$2f$react$2d$client$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTranslations"]
    ];
});
