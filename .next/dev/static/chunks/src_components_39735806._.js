...
const AnimatedHero = ({ lang })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AnimatedHero.useEffect": ()=>{
            ...
            const handleCanPlay = {
                "AnimatedHero.useEffect.handleCanPlay": ()=>{
                    video.play().catch({
                        "AnimatedHero.useEffect.handleCanPlay": ()=>{}
                    }["AnimatedHero.useEffect.handleCanPlay"]);
                    setTimeout({
                        "AnimatedHero.useEffect.handleCanPlay": ()=>setIsVideoReady(true)
                    }["AnimatedHero.useEffect.handleCanPlay"], 100);
                }
            }["AnimatedHero.useEffect.handleCanPlay"];
...
_s(AnimatedHero, "3FlC36sgx0v5XX+zHaTp912Z9ZU=", false, function() {
    return [
...
//# sourceMappingURL=src_components_39735806._.js.map