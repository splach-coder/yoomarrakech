 ...
 */
export const getSiteData = (locale: string) => (locale === 'fr' ? siteDataFr : siteData);
    ...
    tours: [
        {
            ...
            included: ["Hotel pickup & drop-off", "Air-conditioned transport", "Licensed local guide"],
            excluded: ["Lunch", "Monument entrance fees", "Personal expenses & tips"],
            duration: "1_day",
        ...
        },
        {
            ...
            included: ["Hotel pickup & drop-off", "Air-conditioned transport", "Local mountain guide"],
            excluded: ["Lunch", "Mule or camel rides", "Personal expenses & tips"],
            duration: "1_day",
            maxPeople: 8,
        ...
        },
        {
            ...
            included: ["Hotel pickup & drop-off", "Air-conditioned transport", "Free time in the medina"],
            excluded: ["Lunch", "Guided city tour", "Personal expenses & tips"],
            duration: "1_day",
            maxPeople: 7,
        ...
        },
        {
            ...
            included: ["Hotel pickup & drop-off", "Air-conditioned transport", "Local guide at the falls"],
            excluded: ["Lunch", "Boat ride", "Personal expenses & tips"],
            duration: "1_day",
            maxPeople: 8,
        ...
        },
        {
            ...
            included: ["Hotel pickup & drop-off", "Air-conditioned transport", "Local mountain guide"],
            excluded: ["Lunch", "Mule hire", "Personal expenses & tips"],
            duration: "1_day",
            maxPeople: 8,
        ...
        },
        {
            ...
            included: ["Hotel pickup & drop-off", "Air-conditioned transport"],
            excluded: ["Lunch", "Local guide in Fes", "Monument entrance fees"],
            duration: "1_day",
            maxPeople: 8,
        ...
        },
        {
            ...
            included: ["Hotel pickup & drop-off", "Air-conditioned transport"],
            excluded: ["Lunch", "Mosque entrance fee", "Personal expenses & tips"],
            duration: "1_day",
            maxPeople: 8,
        ...
        },
        {
            ...
            included: ["Hotel pickup & drop-off", "Air-conditioned transport"],
            excluded: ["Lunch", "Entrance fees", "Personal expenses & tips"],
            duration: "1_day",
            maxPeople: 8,
        ...
        experiences: [
            {
                ...
                included: ["Professional guide", "Helmet & safety equipment", "Tea break"],
                excluded: ["Hotel pickup", "Tips", "Personal expenses"],
                price: 50,
                duration: "2_hours",
            ...
            },
            {
                ...
                included: ["Camel guide", "Traditional dress & mint tea", "Photo stops"],
                excluded: ["Hotel pickup", "Tips", "Personal expenses"],
                price: 25,
                duration: "1_hour",
            ...
            },
            {
                ...
                included: ["Local chef", "All ingredients", "Lunch — your own creations"],
            ...
            },
            {
                ...
                included: ["Local foodie guide", "All tastings"],
    ...
    transport: [
        {
            ...
            included: ["Professional driver", "Air-conditioned vehicle", "Fuel", "Insurance"],
        ...
        },
        {
            ...
            included: ["Professional driver", "Air-conditioned vehicle", "Meet & greet", "Flight tracking"],
            excluded: ["Tips", "Extra stops"],
            price: 30
        },
        {
            ...
            included: ["Professional driver", "Air-conditioned vehicle", "Fuel", "Insurance"],
            excluded: ["Tips", "Waiting time beyond schedule"],
            price: 20
        }
    ],
    ...
    tours: [
        {
            ...
            included: ["Prise en charge à l'hôtel", "Transport climatisé", "Guide local agréé"],
            excluded: ["Déjeuner", "Entrées des monuments", "Dépenses personnelles & pourboires"],
            duration: "1_day",
            image: "/images/marrakech/marrakech1.jpg",
            gallery: [
                "/images/marrakech/marrakech2.jpg",
        ...
        },
        {
            ...
            included: ["Prise en charge à l'hôtel", "Transport climatisé", "Guide de montagne local"],
            excluded: ["Déjeuner", "Balade à dos de mule ou de dromadaire", "Dépenses personnelles & pourboires"],
            duration: "1_day",
            maxPeople: 8,
            image: "/images/ourika/abdelhamid-azoui-BGU0uaY0tJs-unsplash.jpg",
            gallery: [],
        ...
        },
        {
            ...
            included: ["Prise en charge à l'hôtel", "Transport climatisé", "Temps libre dans la médina"],
            excluded: ["Déjeuner", "Visite guidée de la ville", "Dépenses personnelles & pourboires"],
            duration: "1_day",
            maxPeople: 7,
            image: "/images/essaouira/hamza-omlacho-M9GO4Gsd2SM-unsplash.jpg",
            gallery: [],
        ...
        },
        {
            ...
            included: ["Prise en charge à l'hôtel", "Transport climatisé", "Guide local aux cascades"],
            excluded: ["Déjeuner", "Tour en barque", "Dépenses personnelles & pourboires"],
            duration: "1_day",
            maxPeople: 8,
            image: "/images/ouzoud/danai-tsoutreli-tqLc6On9KIA-unsplash.jpg",
            gallery: [],
        ...
        },
        {
            ...
            included: ["Prise en charge à l'hôtel", "Transport climatisé", "Guide de montagne local"],
            excluded: ["Déjeuner", "Location de mule", "Dépenses personnelles & pourboires"],
            duration: "1_day",
            maxPeople: 8,
            image: "/images/hero-marrakech.jpg",
            gallery: [],
        ...
        },
        {
            ...
            included: ["Prise en charge à l'hôtel", "Transport climatisé"],
            excluded: ["Déjeuner", "Guide local à Fès", "Entrées des monuments"],
            duration: "1_day",
            maxPeople: 8,
            image: "/images/fes/ben-ostrower-bjNv5Bg6h4U-unsplash.jpg",
            gallery: [],
        ...
        },
        {
            ...
            included: ["Prise en charge à l'hôtel", "Transport climatisé"],
            excluded: ["Déjeuner", "Entrée de la mosquée", "Dépenses personnelles & pourboires"],
            duration: "1_day",
            maxPeople: 8,
            image: "/images/casablanca/eka-maitri-viryani-qL3_NSPo9o8-unsplash.jpg",
            gallery: [],
        ...
        },
        {
            ...
            included: ["Prise en charge à l'hôtel", "Transport climatisé"],
            excluded: ["Déjeuner", "Entrées", "Dépenses personnelles & pourboires"],
            duration: "1_day",
            maxPeople: 8,
            image: "/images/ouarzazate/abdou-faiz-lA-P8-vagrI-unsplash.jpg",
            gallery: [],
        ...
        experiences: [
            {
                ...
                included: ["Guide professionnel", "Casque & équipement de sécurité", "Pause thé"],
                excluded: ["Prise en charge à l'hôtel", "Pourboires", "Dépenses personnelles"],
                price: 50,
                duration: "2_hours",
                image: "/images/quad-biking/haris-khan-v40H7tLOZII-unsplash.jpg",
                gallery: [
            ...
            },
            {
                ...
                included: ["Chamelier", "Tenue traditionnelle & thé à la menthe", "Pauses photo"],
                excluded: ["Prise en charge à l'hôtel", "Pourboires", "Dépenses personnelles"],
                price: 25,
                duration: "1_hour",
                image: "/images/camel-riding/oussama-rahib-f7F8URbIx08-unsplash.jpg",
            ...
            },
            {
                ...
                included: ["Chef local", "Tous les ingrédients", "Déjeuner — vos propres créations"],
            ...
            },
            {
                ...
                included: ["Guide gastronomique local", "Toutes les dégustations"],
                excluded: ["Boissons supplémentaires", "Pourboires"],
                price: 45,
                duration: "3_hours",
                image: "/images/food-tour/annie-spratt-_V4v7BbG338-unsplash.jpg",
                gallery: []
    ...
    transport: [
        {
            ...
            included: ["Chauffeur professionnel", "Véhicule climatisé", "Carburant", "Assurance"],
            excluded: ["Pourboires", "Arrêts supplémentaires"],
            price: 50
        },
        {
            id: "airport",
            ...
            included: ["Chauffeur professionnel", "Véhicule climatisé", "Accueil personnalisé", "Suivi des vols"],
            excluded: ["Pourboires", "Arrêts supplémentaires"],
            price: 30
        },
        {
            ...
            included: ["Chauffeur professionnel", "Véhicule climatisé", "Carburant", "Assurance"],
            excluded: ["Pourboires", "Temps d'attente hors planning"],
            price: 20
        }
    ],
