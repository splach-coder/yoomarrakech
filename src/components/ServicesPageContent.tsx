                                        ...
                                        >
                                            <div className="bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col md:flex-row h-auto md:h-[350px] border border-neutral-100 hover:-translate-y-1">
                                                ...
                                                <div className="md:w-3/5 p-6 md:p-8 flex flex-col justify-between">
                                                    ...
                                                    <div className="pt-6 mt-4 border-t border-neutral-100 flex flex-col xl:flex-row xl:items-center justify-between gap-4 xl:gap-2">
                                                        <div>
                                                        ...
                                                        <div className="flex items-center gap-2 w-full xl:w-auto">
                                                            <Link
                                                                ...
                                                                className="flex-1 xl:flex-none justify-center px-5 py-2.5 rounded-full bg-neutral-100 text-neutral-dark font-medium text-sm hover:bg-neutral-200 transition-all flex items-center gap-2"
                                                            >
                                                                Details <ArrowUpRight className="w-4 h-4" />
                                                            </Link>
                                                            <button
                                                                className="flex-1 xl:flex-none justify-center px-5 py-2.5 rounded-full bg-[#FDC82F] text-[#1A1A1A] font-bold text-sm hover:bg-[#e6b528] transition-all flex items-center gap-2 shadow-sm"
