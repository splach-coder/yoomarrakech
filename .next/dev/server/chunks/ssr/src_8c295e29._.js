...
function TourDetailPage({ params }) {
    ...
    const item = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$siteData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSiteData"])(locale).tours.find((t)=>t.id === id);
    if (!item) {
